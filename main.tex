...
% TODO: donner une version "pitchfork" des règles.
...
% TODO: présenter les règles positive et négative en analogie avec les règles du système focalisé de MALL, et les expliquer en termes de processus d'argumentation entre un proposant et un opposant, le daimon représentant l'abandon d'un joueur.

% TODO: enchaîner naturellement sur la notion de dessin, interprétable comme une stratégie argumentative, et illustrer avec un exemple modélisant une situation IRL.

% TODO: rajouter un deuxième dessin pour l'opposant permettant d'introduire l'idée de normalisation.
